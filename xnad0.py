#import random  Пока думаю как с помощью рендома сделать игру компьютера с человеком.
...
for i in range(10):
    ...
    second = proverka()
    playy(second)
#Пока не получается чделать так, чтоб если 1 игрок вел, то второй если выберает такую же цифру, то у второго написало отказ. А то перезаписывает веденные раньше цифры
